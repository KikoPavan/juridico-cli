# block-extraction-strategy-selection Specification

## Purpose
TBD - created by syncing change fix-skill-specific-block-extraction-fallback. Update Purpose after archive.
