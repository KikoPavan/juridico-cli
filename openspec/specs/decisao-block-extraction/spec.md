# decisao-block-extraction Specification

## Purpose
Definir a extração em blocos exclusiva de `extr-decisao-processo`, com consolidação compatível com o schema canônico, fallback literal e preservação de rastreabilidade judicial.
