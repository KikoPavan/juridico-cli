#!/usr/bin/env bash
# md-clean-markdown · package_skill.sh
# ======================================
# Empacota a skill md-clean-markdown em arquivo .zip para distribuição.
#
# Saída: ~/devops/juridico-cli/var/artifacts/skills/md-clean-markdown.zip
#
# Uso:
...
DEFAULT_ZIP="$PROJECT_DIR/var/artifacts/skills/md-clean-markdown.zip"
...
echo "[package_skill] Empacotando: md-clean-markdown"
