#!/usr/bin/env python3
"""Validate a JSON output file against the peticao_processo schema."""
...
ASSET_SCHEMA = Path(__file__).parent.parent / "assets" / "peticao_processo.schema.json"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Validate peticao_processo JSON output.")
