#!/usr/bin/env python3
"""Validate a JSON output file against the procuracao schema (v3.1)."""
...
ASSET_SCHEMA = Path(__file__).parent.parent / "assets" / "procuracao.schema.json"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Validate procuracao JSON output.")
