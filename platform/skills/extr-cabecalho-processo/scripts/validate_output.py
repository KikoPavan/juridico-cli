#!/usr/bin/env python3
"""Validate a JSON output file against the cabecalho_processo schema."""
...
ASSET_SCHEMA = Path(__file__).parent.parent / "assets" / "cabecalho_processo.schema.json"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Validate cabecalho_processo JSON output.")
