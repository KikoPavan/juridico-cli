#!/usr/bin/env python3
"""Validate a JSON output file against the escritura_hipotecaria schema."""
...
SCHEMA_PATH = Path(__file__).parent.parent / "assets" / "escritura_hipotecaria.schema.json"
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Validate escritura_hipotecaria JSON output against the canonical schema."
    )
    parser.add_argument(
        "--input",
        required=True,
