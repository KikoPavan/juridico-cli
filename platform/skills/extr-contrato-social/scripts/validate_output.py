#!/usr/bin/env python3
"""Validate a JSON output file against the contrato_social schema."""
...
SCHEMA_PATH = Path(__file__).parent.parent / "assets" / "contrato_social.schema.json"
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Validate contrato_social JSON output against the canonical schema."
    )
    parser.add_argument(
        "--input",
        required=True,
